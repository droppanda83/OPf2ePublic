...
exports.rollDamageFormula = exports.SPELL_CATALOG = void 0;
exports.getSpell = getSpell;
exports.getSpellByName = getSpellByName;
exports.resolveSpellId = resolveSpellId;
// Spell catalog
exports.SPELL_CATALOG = {
    'magic-missile': {
        id: 'magic-missile',
        name: 'Force Barrage',
        rank: 1,
...
function getSpell(spellId) {
    return exports.SPELL_CATALOG[spellId];
}
/**
 ...
 */
function getSpellByName(displayName) {
    const cleaned = displayName
        .replace(/\s*\(Archetype\)\s*$/i, '')
        .replace(/\s*\(Psychic\)\s*$/i, '')
        .trim()
        .toLowerCase();
    return Object.values(exports.SPELL_CATALOG).find(spell => spell.name.toLowerCase() === cleaned);
}
/**
 ...
 *   "Fireball" → "fireball"
 */
function resolveSpellId(displayName) {
...
const rollDamageFormula = (formula) => {
...
exports.rollDamageFormula = rollDamageFormula;
