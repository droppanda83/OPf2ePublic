...
export const SHADOWCASTER_FEATS: FeatEntry[] = [
  ...
  },
  {
    ...
    category: 'archetype',
    level: 12,
    description: 'Your shadow reservoir gains an additional spell 1 level below your highest (in addition to existing spells at all levels below that). You also gain negative resistance equal to highest spell rank you can cast from slots (positive resistance if you have negative healing).',
    implemented: 'full',
    traits: ['Archetype'],
    actionCost: 'passive',
    prerequisites: ['Shadow Reservoir'],
    mechanics: '+1 reservoir spell at (highest–1) level. Resistance negative (or positive) = highest spell rank.',
  },
  {
