...
export const REANIMATOR_FEATS: FeatEntry[] = [
  {
    ...
    category: 'archetype',
    level: 2,
    description: 'You have dedicated your studies to the art of raising and commanding undead. If you\'re a prepared spellcaster with animate dead in your spell list, you can change animate dead\'s spell rank freely when you prepare it (traits change to match). If spontaneous with animate dead in your repertoire, you can swap animate dead for a different spell each morning and can make it your signature spell. When you cast animate dead, you gain a +1 status bonus to the counteract check if you target humanoid remains or a creature whose level is lower than the spell rank.',
    implemented: 'full',
    traits: ['Archetype', 'Dedication'],
    actionCost: 'passive',
    prerequisites: ['Able to cast animate dead with a spell slot'],
    mechanics: 'Prepared: freely change animate dead spell rank. Spontaneous: swap/signature spell. +1 status to counteract check vs humanoid remains or lower-level creatures.',
  },
  {
...
export const SOUL_WARDEN_FEATS: FeatEntry[] = [
  {
    ...
    category: 'archetype',
    level: 2,
    description: 'You can take the burden of souls upon yourself to protect the living and the dead. You gain a spiral sigil, a unique symbol emblazoned on your clothing or branded on your flesh. Your spiral sigil glows faintly when undead or a soul that isn\'t at rest is within 100 feet of you. You can cast vitality lash as a divine innate cantrip. As normal, it is automatically heightened to half your level rounded up.',
    implemented: 'full',
    traits: ['Archetype', 'Dedication'],
    actionCost: 'passive',
    prerequisites: ['Trained in Occultism or Religion', 'Worships Pharasma or a psychopomp usher'],
    mechanics: 'Spiral sigil: glows when undead/unrestful soul within 100 ft. Innate divine cantrip: vitality lash (auto-heightened).',
  },
  {
  ...
  },
  {
    ...
    category: 'archetype',
    level: 6,
    description: 'You swear to destroy an undead creature or a creature that has imprisoned a soul, calling upon the power of your spiral sigil. You gain a status bonus to damage against the target equal to the number of weapon damage dice for Strikes or to the spell rank for spells. This benefit lasts for 1 minute.',
    implemented: 'full',
    traits: ['Archetype', 'Concentrate', 'Divine', 'Evocation'],
    actionCost: 1,
    prerequisites: ['Soul Warden Dedication'],
    mechanics: '1 action. Frequency: 1/10 min. Status bonus to damage vs target = weapon dice count (Strikes) or spell rank (spells). 1 min duration.',
  },
  {
