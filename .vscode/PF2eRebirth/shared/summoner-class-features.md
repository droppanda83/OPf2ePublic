...
**Legacy Content** (not remastered into Player Core 2)
...
When the Master Summoner, Ostentatious Arrival, and Legendary Summoner feats refer to summoning spells, they mean spells that conjure a creature with the summoned trait. The spells that qualify from the Core Rulebook and Secrets of Magic are: summon anarch, summon animal, summon axiom, summon celestial, summon construct, summon dragon, summon elemental, summon entity, summon fey, summon fiend, summon giant, summon plant or fungus, and summon undead.
...
## Summoner Spells Per Day (Bounded Spellcasting)
...
**Note:** The Summoner uses **bounded spellcasting** — fewer spell slots than full casters (maximum 4 slots at any time). Lower-level spell slots are lost as you gain higher-level ones starting at level 5.

---

## Eidolon Types Available

| Eidolon Type | Tradition | Source | Traits |
|---|---|---|---|
| Angel Eidolon | Divine | Secrets of Magic pg. 59 | Angel, Celestial, Eidolon |
| Anger Phantom Eidolon | Occult | Secrets of Magic pg. 59 | Eidolon, Ethereal, Phantom |
| Beast Eidolon | Primal | Secrets of Magic pg. 61 | Beast, Eidolon |
| Construct Eidolon | Arcane | Secrets of Magic pg. 61 | Astral, Construct, Eidolon |
| Demon Eidolon | Divine | Secrets of Magic pg. 62 | Demon, Eidolon, Fiend |
| Devotion Phantom Eidolon | Occult | Secrets of Magic pg. 63 | Eidolon, Ethereal, Phantom |
| Dragon Eidolon | Arcane | Secrets of Magic pg. 64 | Astral, Dragon, Eidolon |
| Elemental Eidolon | Primal | Rage of Elements pg. 38 | Eidolon, Elemental |
| Fey Eidolon | Primal | Secrets of Magic pg. 64 | Eidolon, Fey |
| Plant Eidolon | Primal | Secrets of Magic pg. 65 | Eidolon, Plant |
| Psychopomp Eidolon | Divine | Secrets of Magic pg. 66 | Eidolon, Monitor, Psychopomp |
| Swarm Eidolon | Primal | Battlecry! pg. 72 | Animal, Eidolon, Swarm |
| Undead Eidolon | Divine | Book of the Dead pg. 36 | Eidolon, Undead |

---

## Class Features — Full Descriptions

---

### Ancestry and Background (Level 1)
...
### Summoner Proficiencies by Level

| Feature | Starting | Level Increase | Final |
|---|---|---|---|
| Perception | Trained | Expert at 3 (Shared Vigilance) | Expert |
| Fortitude | Expert | Master at 11 (Twin Juggernauts) | Master |
| Reflex | Trained | Expert at 9 (Shared Reflexes) | Expert |
| Will | Expert | Master at 15 (Shared Resolve) | Master |
| Simple Weapons | Trained | Expert at 11 (Simple Weapon Expertise) | Expert |
| Unarmed Attacks | Trained | Expert at 11 (Simple Weapon Expertise) | Expert |
| Unarmored Defense | Trained | Expert at 13 (Defensive Robes) | Expert |
| Spell Attacks/DCs | Trained | Expert at 9, Master at 17 | Master |

### Eidolon Proficiencies by Level
...
| Reflex | Trained | Expert at 9 (Shared Reflexes) | Expert |
| Will | Expert | Master at 15 (Shared Resolve) | Master |
| Unarmed Attacks | Trained | Expert at 5, Master at 13 | Master |
| Unarmored Defense | Trained | Expert at 11, Master at 19 | Master |
