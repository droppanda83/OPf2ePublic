# Oracle Class Features (Player Core 2)
...
## Oracle Class Progression Table
...
\* The oracular clarity class feature gives you a 10th-rank spell slot that works a bit differently from other spell slots.
...
## Attribute Boosts (Level 1, 5, 10, 15, 20)
...
## Oracle Spellcasting (Level 1)

**Action Cost:** Passive (uses Cast a Spell activity)
**Traits:** Divine, Spontaneous
...
**Available Mysteries:** Ancestors, Battle, Bones, Cosmos, Flames, Life, Lore, Tempest, Time
...
**Cursebound Progression:**
- Maximum cursebound 2 (Levels 1–10)
- Maximum cursebound 3 (Levels 11–16, via Major Curse)
- Maximum cursebound 4 (Levels 17+, via Extreme Curse)
